...
#echo "Hello World!"
​
# name="Jordan Bush" #convention for naming variables in bash
# greeting="Hello"
​
# echo my name is ${name} # my name is Jordan Bush
# echo my name is $name # my name is Jordan Bush
# echo $greeting, my name is $name # Hello, my name is Jordan Bush
​
# echo "hello there" $1
# echo "Hello there" $2
...
# case $car in 
#     "Testla")
#         echo -n "You are a big man using ${car} in United States"
#         ;;
#     "Toyota" | "honda" | "Nissan")
#         echo -n "You follow for middle class people using ${car} in United States"
#         ;;
#     "Mercedes" | "BMW" | "Audi")
#         echo -n "You arrive using ${car} in United States"
#         ;;
#     *)
#         echo -n "You no follow for popular cars  using ${car} in United States"
#         ;;
# esac
​
#Bash Loops
...
greet "Jordan" "Hello World"
greet "Michaela" "You are a nice guy"
​
#Assignment 1
